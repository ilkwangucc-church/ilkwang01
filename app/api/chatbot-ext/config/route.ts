    ...
    return Response.json(
      {
        ...
        // 일광교회 기본 색상 (초록)
        primary_color: settings["primary_color"] || "#2E7D32",
        secondary_color: settings["secondary_color"] || "#6DBF73",
        header_bg_color: settings["header_bg_color"] || "#2E7D32",
        user_bubble_color: settings["user_bubble_color"] || "#2E7D32",
        bot_bubble_color: settings["bot_bubble_color"] || "#F1F5F2",
