        ...
        <div className="max-w-[1400px] mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12 max-w-3xl mx-auto">
            ...
            <div className="bg-blue-50 rounded-2xl p-7">
              <h3 className="font-bold text-blue-800 mb-4 text-lg">주중 모임</h3>
              <ul className="text-sm text-gray-700 space-y-2">
                <li>📅 금요 기도 모임 — 매주 금요일 오후 7:30</li>
                <li>📅 소그룹 성경공부 — 격주 토요일 오후 2:00</li>
                <li>📅 임원 모임 — 월 1회</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3 max-w-3xl mx-auto">
            {[
              ...
              <div key={p.period} className="flex items-center gap-4 bg-gray-50 rounded-lg px-5 py-3">
                <span className="shrink-0 text-indigo-600 font-bold text-sm w-12">{p.period}</span>
                <span className="text-gray-700 text-sm">{p.event}</span>
              </div>
            ))}
          </div>
        </div>
