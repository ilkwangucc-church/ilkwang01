      ...
      <section className="py-8 sm:py-16 bg-white">
        <div className="max-w-[1400px] mx-auto px-4">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">청년부 비전</h2>
          ...
          {/* 연간 행사 */}
          <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-center">연간 주요 행사</h2>
          <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 mb-8 sm:mb-12 max-w-3xl mx-auto">
            {[
              ...
              <div key={e.title} className="flex gap-4 bg-gray-50 rounded-xl p-4 sm:p-5">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 text-sm break-keep">{e.title}</h4>
                  <p className="text-xs text-gray-500 mt-0.5 break-keep">{e.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* CTA */}
          <div className="text-center bg-[#1B5E20] text-white rounded-2xl p-6 sm:p-10">
