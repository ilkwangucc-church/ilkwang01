...
const communities = [
  { icon: "🙏", name: "예배공동체", desc: "하나님을 위하여 존재하는 공동체", detail: "온 마음과 정성을 다해 살아계신 하나님께 예배드리며, 주일 예배를 신앙 생활의 중심으로 삼습니다. 참된 예배를 통해 하나님과의 관계를 회복하고 성도들이 함께 세워져 갑니다." },
  { icon: "📖", name: "훈련공동체", desc: "성도를 말씀으로 세우는 공동체", detail: "성경 말씀을 통해 예수 그리스도의 제자로 훈련받고 성장합니다. 체계적인 말씀 교육과 소그룹 훈련을 통해 성숙한 신앙인을 세워갑니다." },
  { icon: "❤️", name: "치유공동체", desc: "가정과 사회를 변화시키는 공동체", detail: "상처받은 영혼을 품고 가정을 회복시키며, 지역사회에 하나님의 사랑을 전합니다. 성령의 능력으로 삶의 모든 영역에서 치유와 회복이 일어납니다." },
  { icon: "🌟", name: "비전공동체", desc: "미래의 지도자를 세우는 공동체", detail: "다음 세대를 향한 투자와 양육을 통해 미래의 교회 지도자들을 세워갑니다. 청소년과 청년들이 하나님의 비전을 품고 자라나는 공동체입니다." },
  { icon: "🌍", name: "선교공동체", desc: "지구촌 땅 끝까지 복음을 전하는 공동체", detail: "국내외 선교를 통해 하나님 나라를 확장하고 열방을 향한 선교 사명을 감당합니다. 땅 끝까지 복음을 전하는 선교적 교회를 지향합니다." },
];
