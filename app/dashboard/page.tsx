...
const stats = [
  { label: "전체 회원수",    value: "342명",   icon: Users,         color: "text-blue-600",   bg: "bg-blue-50",   href: "/dashboard/members" },
  { label: "이번달 설교",    value: "8편",     icon: BookOpen,      color: "text-green-600",  bg: "bg-green-50",  href: "/dashboard/sermons" },
  { label: "미확인 문의",    value: "3건",     icon: MessageSquare, color: "text-rose-600",   bg: "bg-rose-50",   href: "/dashboard/contacts" },
  { label: "이번달 헌금",    value: "2,450만원", icon: DollarSign,   color: "text-purple-600", bg: "bg-purple-50", href: "/dashboard/offerings" },
];

const quickMenus = [
  { label: "회원 관리",       href: "/dashboard/members",        icon: "👥", desc: "7단계 등급 관리" },
  { label: "교인 관리",       href: "/dashboard/church-members", icon: "📋", desc: "교적 명부" },
  { label: "증명서 발급",     href: "/dashboard/certificates",   icon: "📜", desc: "등록·세례 증명" },
  { label: "문의 접수함",     href: "/dashboard/contacts",       icon: "💬", desc: "홈페이지 문의" },
  { label: "홈 화면 수정",    href: "/dashboard/hero",           icon: "🖥️", desc: "메인 배너 편집" },
  { label: "섬기는 사람들",   href: "/dashboard/ministers",      icon: "🙏", desc: "교역자·봉사자" },
  { label: "부서 소개 수정",  href: "/dashboard/departments",    icon: "🏢", desc: "부서별 소개" },
  { label: "미디어 관리",     href: "/dashboard/media",          icon: "🎬", desc: "동영상·이미지" },
];
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50">
            ...
            <Link href="/dashboard/notices" className="flex items-center gap-1 text-xs text-[#2E7D32] hover:underline">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50">
            ...
            <Link href="/dashboard/contacts" className="flex items-center gap-1 text-xs text-[#2E7D32] hover:underline">
              전체보기 <ArrowRight className="w-3 h-3" />
            </Link>
          </div>
          <div className="divide-y divide-gray-50">
