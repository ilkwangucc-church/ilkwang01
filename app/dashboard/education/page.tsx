...
const STATUS_COLORS: Record<string, string> = {
  "등록중": "bg-gray-100 text-gray-600",
  "진행중": "bg-gray-100 text-gray-600",
    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-2xl overflow-hidden min-h-[120px] sm:h-44">
        ...
        <div className="relative z-10 p-6 h-full flex flex-col justify-center">
          ...
          <p className="text-white/70 text-sm">일광교회 신앙 교육 프로그램 · 2026년 상반기</p>
                ...
                <div key={item.title} className="px-5 py-4 hover:bg-gray-50 transition-colors cursor-pointer group">
                  <div className="flex items-start justify-between gap-3 mb-1.5">
                    <div className="flex items-center gap-2">
                      <p className="font-semibold text-gray-900 group-hover:text-gray-700 transition-colors">{item.title}</p>
                  ...
                  <p className="text-xs text-gray-500 font-medium mb-2">{item.schedule}</p>
                  <div className="flex items-center gap-4">
                    ...
                    <span className="flex items-center gap-1 text-xs text-gray-500">
                      <Star className="w-3 h-3 text-gray-400" /> 4.9
                    </span>
                  </div>
                </div>
              ))}
