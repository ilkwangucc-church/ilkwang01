...
const POSTS = [
 { id: 1, dept: "청년부", author: "이은혜", avatar: "이", color: "bg-gray-100 text-gray-600",
 ...
 { id: 2, dept: "찬양팀", author: "박찬양", avatar: "박", color: "bg-gray-100 text-gray-600",
 title: "주일 찬양 곡 목록 공유",
 ...
 { id: 3, dept: "봉사부", author: "최봉사", avatar: "최", color: "bg-gray-100 text-gray-600",
 title: "4월 봉사 일정 공유",
 preview: "4월 봉사 일정을 공유드립니다. 참여 가능하신 분들은 댓글 남겨주세요! 지역사회를 섬기는 소중한 기회입니다.",
 image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=600&q=80",
 date: "2026-03-30", likes: 12, comments: 14 },
 { id: 4, dept: "새가족부", author: "김환영", avatar: "김", color: "bg-gray-100 text-gray-600",
 title: "3월 새가족 환영 모임",
 preview: "이번 달 새로 등록하신 5분을 환영합니다! 다 함께 잘 돌봐주세요 새가족분들이 교회에 잘 정착하실 수 있도록 함께 기도해요.",
 ...
 { id: 5, dept: "예배부", author: "정예배", avatar: "정", color: "bg-gray-100 text-gray-600",
 title: "부활절 예배 준비 안내",
 ...
 { id: 6, dept: "교육부", author: "박교육", avatar: "박", color: "bg-gray-100 text-gray-600",
...
export default function DeptSharePage() {
 ...
 <ChevronRight className="w-3.5 h-3.5 text-gray-300 group-hover:text-gray-500 transition-colors ml-auto" />
 </div>
 <h3 className="font-bold text-gray-900 mb-1.5 group-hover:text-gray-700 transition-colors text-sm leading-snug line-clamp-1">
 {post.title}
 </h3>
 ...
 className={`flex items-center gap-1 text-xs transition-colors ${liked.has(post.id) ? "text-gray-600" : "text-gray-400 hover:text-gray-600"}`}
 >
