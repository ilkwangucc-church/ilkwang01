...
const DIALOGUE_SEEDS: DialogueSeed[] = [
  ...
  sharedSeed(
    ...
    "처음 방문이시면 주일 2부 오전 11:00 예배를 가장 기본 예배로 안내해 드리기 좋습니다. 조금 이른 시간을 원하시면 1부 오전 9:30, 오후 시간이 편하시면 주일 오후예배 오후 1:30도 가능합니다.",
  ),
  sharedSeed(
    "weekday_worship",
    ["주중", "평일", "수요", "새벽"],
  ...
  sharedSeed(
    ...
    "주일에는 1부 오전 9:30, 2부 오전 11:00, 주일 오후예배 오후 1:30이 있습니다. 처음 방문이시면 2부 오전 11:00 예배를 가장 기본으로 안내해 드리기 좋습니다.",
  ),
  sharedSeed(
    "simple_smalltalk",
    ["대화", "수다", "편하게"],
