...
const CHURCH_FAQ_SEEDS: FaqSeed[] = [
  ...
  { category: "worship", question: "주일예배 시간은 어떻게 되나요?", answer: lines("주일예배는 세 번 있습니다.", "1부 오전 9:30", "2부 오전 11:00", "주일 오후예배 오후 1:30"), keywords: ["주일예배", "예배 시간", "장년부", "오후예배"] },
  ...
  { category: "worship", question: "주일 오후예배 시간은 언제인가요?", answer: "주일 오후예배는 오후 1:30에 본당에서 드립니다.", keywords: ["3부 예배", "오후예배", "주일 오후예배", "오후 1:30"] },
