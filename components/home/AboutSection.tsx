export default function AboutSection() {
  return (
    <section
      className="relative py-14 sm:py-20 lg:py-28 bg-cover bg-center bg-no-repeat overflow-hidden"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-[10px] sm:px-6">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div>
            {/* Quote marks */}
            <div className="text-[#2E7D32] text-5xl sm:text-6xl font-black leading-none mb-4 opacity-80">"</div>
            <blockquote className="text-white text-xl sm:text-2xl lg:text-3xl font-bold leading-snug mb-6 sm:mb-8 text-center md:text-left break-keep">
              우리의 목표는 지역 사회에서 소외된 이웃들에게 복음의 빛을 전하고,
              모든 사람이 하나님의 사랑 안에서 새로운 삶을 시작하도록 돕는 것입니다.
            </blockquote>
            <p className="text-gray-300 leading-relaxed mb-8 text-center md:text-left text-sm sm:text-base break-keep">
