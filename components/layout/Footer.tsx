    ...
    <footer className="bg-[#1a2744] text-gray-300">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          <div className="mb-5 p-3 bg-white inline-block rounded-lg">
            <Image src="/logo.png" alt="일광교회" width={114} height={30} />
          </div>
          <p className="text-sm text-gray-400 leading-relaxed mb-5">
            대한예수교장로회(합동) 소속<br />
            1971년 설립된 서울 성북구 일광교회
          </p>
          <p className="text-sm font-bold text-white">02-927-0691</p>
        </div>
